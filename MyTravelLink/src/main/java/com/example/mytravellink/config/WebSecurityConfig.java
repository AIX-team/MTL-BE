    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers("/", "/login/**","/auth/google/callback","/images/**","/swagger-ui/**","/api-docs/**","/api*","/v3/api-docs/**", "/swagger-resources/**","/auth/send-code","/auth/verify-code").permitAll();
